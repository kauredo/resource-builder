/**
 * Starter template data for the Convex runtime.
 * This is a parallel copy of the template definitions from src/lib/starter-templates.ts
 * since Convex cannot import from src/.
 *
 * Structure: Map of templateId → { type, name, description, tags, content }
 * Only the fields needed for resource creation are included here.
 */
...
export const TEMPLATE_DATA: Record<string, TemplateData> = {
  // --- Emotion Cards ---
  "anxiety-emotion-cards": {
    type: "emotion_cards",
    name: "Anxiety Feelings Deck",
    description: "Eight emotion cards focused on anxiety-related feelings, from worried to relieved.",
    ...
    content: {
      ...
      layout: { cardsPerPage: 4, cardSize: "medium", showLabels: true, showDescriptions: true },
    },
  },
  "primary-emotion-cards": {
    type: "emotion_cards",
    name: "Primary Emotions Deck",
    description: "Eight core emotions every child should learn to recognise.",
    tags: ["emotions"],
    content: {
      cards: [
  ...
  // --- Flashcards ---
  "anxiety-coping-flashcards": {
    type: "flashcards",
    name: "Anxiety Coping Cards",
    description: "Practical coping strategies for anxious moments.",
    tags: ["anxiety", "coping"],
    content: {
      cards: [
        { id: "fc-anx-1", frontText: "Deep Breathing", backText: "Breathe in for 4 counts, hold for 4, breathe out for 4. This activates your body's calm-down system.", imagePrompt: "A child sitting peacefully with eyes closed, surrounded by gentle swirling air currents" },
        { id: "fc-anx-2", frontText: "5-4-3-2-1 Grounding", backText: "Name 5 things you see, 4 you hear, 3 you touch, 2 you smell, 1 you taste. This brings you back to the present moment.", imagePrompt: "A child looking around with curiosity, noticing different sensory details in a colorful environment" },
        { id: "fc-anx-3", frontText: "Worry Box", backText: "Write your worry on a piece of paper, fold it up, and put it in your worry box. You can deal with it later when you're ready.", imagePrompt: "A decorated box with a slot on top, surrounded by small folded papers" },
        { id: "fc-anx-4", frontText: "Muscle Squeeze", backText: "Squeeze your fists tight for 5 seconds, then let go. Feel the difference between tense and relaxed.", imagePrompt: "A child squeezing their fists with determination, then opening their hands with relaxation" },
        { id: "fc-anx-5", frontText: "Positive Self-Talk", backText: "Replace \"What if something bad happens?\" with \"I can handle this\" or \"I've done hard things before.\"", imagePrompt: "A child looking in a mirror with a confident, encouraging expression" },
        { id: "fc-anx-6", frontText: "Safe Place Visualization", backText: "Close your eyes and picture your favourite safe, happy place. Notice what you see, hear, and feel there.", imagePrompt: "A dreamy, peaceful landscape with soft colours representing a child's safe imaginary place" },
        { id: "fc-anx-7", frontText: "Body Scan", backText: "Starting from your toes, slowly move your attention up through your body. Notice where you feel tight or uncomfortable.", imagePrompt: "A child lying down relaxed, with gentle glowing light moving from their feet to their head" },
        { id: "fc-anx-8", frontText: "Butterfly Hug", backText: "Cross your arms over your chest and tap your shoulders one at a time, like a butterfly flapping its wings.", imagePrompt: "A child giving themselves a butterfly hug with crossed arms and gentle expression" },
      ],
    },
  },
  "social-skills-flashcards": {
    ...
    description: "Key social skills broken into simple steps.",
    tags: ["social-skills"],
    content: {
      cards: [
        { id: "fc-soc-1", frontText: "Starting a Conversation", backText: "Smile, make eye contact, and say something about what's happening. Try: \"Hi! What are you playing?\" or \"That looks fun!\"", imagePrompt: "Two children meeting and smiling, one waving hello to the other" },
        { id: "fc-soc-2", frontText: "Taking Turns", backText: "When playing or talking, everyone gets a turn. Wait for your turn patiently and say \"Your turn!\" when you're done.", imagePrompt: "Children in a circle taking turns with a game, one child passing to the next" },
        { id: "fc-soc-3", frontText: "Listening Skills", backText: "Face the person, look at their eyes, keep your body still, and think about what they're saying before you respond.", imagePrompt: "A child leaning in attentively while another child speaks, showing active listening" },
        { id: "fc-soc-4", frontText: "Saying Sorry", backText: "Name what you did: \"I'm sorry I...\" Say how the other person might feel. Ask what you can do to help fix it.", imagePrompt: "One child apologising to another with a sincere expression, the other starting to smile" },
        { id: "fc-soc-5", frontText: "Sharing", backText: "Offer to share by saying \"Do you want to use this too?\" Take turns, or find a way to use it together.", imagePrompt: "Two children happily sharing toys or art supplies together" },
        { id: "fc-soc-6", frontText: "Dealing with Disagreements", backText: "Stay calm, use words not actions. Say how you feel: \"I feel upset because...\" Try to find a solution together.", imagePrompt: "Two children talking calmly through a disagreement, with thought bubbles showing compromise" },
      ],
    },
  },
  "anger-management-flashcards": {
    ...
    description: "Tools and techniques for managing anger safely.",
    tags: ["anger", "coping"],
    content: {
      cards: [
        { id: "fc-ang-1", frontText: "Anger Thermometer", backText: "Rate your anger 1-10. Under 5? Try calm-down strategies. Over 5? Take a break first, then come back to solve the problem.", imagePrompt: "A large thermometer with colours from cool blue at the bottom to hot red at the top" },
        { id: "fc-ang-2", frontText: "Cool-Down Corner", backText: "Go to a quiet spot, take 10 deep breaths, squeeze a stress ball, or draw how you feel. Come back when you're below a 5.", imagePrompt: "A cozy corner with cushions, a stress ball, and drawing supplies" },
        { id: "fc-ang-3", frontText: "Stop, Think, Act", backText: "STOP before you react. THINK about what will happen next. ACT by choosing the best response.", imagePrompt: "Three panels showing a stop sign, a thinking face, and a child making a good choice" },
        { id: "fc-ang-4", frontText: "I-Statements", backText: "Instead of \"You made me angry!\", try \"I feel angry when... because... I need...\" This helps others understand you.", imagePrompt: "A child speaking calmly with a speech bubble showing an I-statement" },
        { id: "fc-ang-5", frontText: "Physical Release", backText: "Run on the spot, do jumping jacks, push against a wall, or squeeze a pillow. Moving your body helps release anger safely.", imagePrompt: "A child doing jumping jacks with energetic lines around them, looking determined" },
        { id: "fc-ang-6", frontText: "Turtle Technique", backText: "Like a turtle going into its shell: stop, tuck in (cross arms, head down), take 3 breaths, think of a plan, come out and try it.", imagePrompt: "A friendly turtle pulling into its shell, then coming back out with a calm expression" },
      ],
    },
  },
  ...
  "my-strengths-star": {
    ...
    description: "A self-esteem building worksheet helping children identify their strengths and draw themselves as superheroes.",
    tags: ["self-esteem"],
    content: {
  ...
  "mindful-moment-worksheet": {
    type: "worksheet",
    name: "My Mindful Moment",
    description: "A grounding worksheet guiding children through noticing their senses and present moment.",
    tags: ["mindfulness"],
    content: {
  ...
  // --- Posters ---
  "anxiety-coping-poster": {
    type: "poster",
    name: "When I Feel Worried...",
    description: "A reassuring poster with coping reminders for anxious moments.",
    tags: ["anxiety", "coping"],
    content: {
  ...
  "anger-cooldown-poster": {
    type: "poster",
    name: "My Cool-Down Plan",
    description: "A visual reminder of anger management steps.",
    tags: ["anger", "coping"],
    content: {
  ...
  "emotions-board-game": {
    ...
    description: "A 36-space board game with emotion check-ins, act-it-out challenges, and calming activities.",
    tags: ["emotions"],
    content: {
      grid: {
        rows: 6,
  ...
  // --- Card Games ---
  "strengths-powers-card-game": {
    type: "card_game",
    name: "Strengths & Powers",
    description: "A therapeutic card game encouraging children to explore their strengths, face challenges, and practise kindness.",
    tags: ["self-esteem"],
    content: {
  ...
  "worry-monster-book": {
    ...
    description: "A gentle social story about learning to manage anxiety.",
    tags: ["anxiety"],
    content: {
      ...
      pages: [
        { id: "p-1", text: "Sometimes a little monster visits me. It sits on my shoulder and whispers worries in my ear.", imagePrompt: "A small, fluffy monster sitting on a child's shoulder, whispering — not scary, more mischievous" },
        { id: "p-2", text: "\"What if nobody wants to play with you?\" it says. \"What if you get the answer wrong?\"", imagePrompt: "The worry monster growing slightly bigger as worry speech bubbles float around the child" },
        { id: "p-3", text: "When the monster talks too loud, my tummy feels funny and my hands get sweaty.", imagePrompt: "The child looking uncomfortable with the monster now quite large, holding their tummy" },
        { id: "p-4", text: "But my teacher showed me a secret. I can take a big deep breath — in through my nose, out through my mouth.", imagePrompt: "The child taking a deep breath with their eyes closed, a calm wind swirling around them" },
        { id: "p-5", text: "When I breathe, the monster gets smaller. It's still there, but it's not so loud anymore.", imagePrompt: "The monster shrinking back to a tiny size as the child breathes calmly and smiles" },
        { id: "p-6", text: "I learned that everyone has a worry monster. Even grown-ups! And that's completely okay.", imagePrompt: "Multiple children and adults, each with their own tiny, friendly worry monsters — everyone smiling" },
      ],
    },
  },
  "self-esteem-book": {
    ...
    description: "A social story celebrating individuality and building self-worth.",
    tags: ["self-esteem"],
    content: {
      bookType: "social story",
      layout: "picture_book",
      ...
      pages: [
        { id: "p-1", text: "My name is [Name], and there is nobody else in the whole world exactly like me.", imagePrompt: "A child standing proudly in the center of a colourful world, unique patterns radiating from them" },
        { id: "p-2", text: "Sometimes I'm really good at things. And sometimes I make mistakes. Both of those are okay.", imagePrompt: "Split scene: child painting a masterpiece on one side, and spilling paint on the other — smiling in both" },
        { id: "p-3", text: "I'm a good friend because I listen and I care about how other people feel.", imagePrompt: "A child sitting with a sad friend, putting a comforting hand on their shoulder" },
